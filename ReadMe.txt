...
1. Run following command to execute:
    ...
    For e.g. -  
    # java -cp /var/shikha-data/java-project/LoanProfiles/target/LoanProfiles-1.0.jar org.fin.loans.main.GenerateTicker "https://test-json-upload-test.s3.ap-south-1.amazonaws.com/marketdata.json"
...
3. Run following command to execute:
       ...
       For e.g. -
       # java -cp /var/shikha-data/java-project/LoanProfiles/target/LoanProfiles-1.0.jar org.fin.loans.main.GenerateLoanAlerts marketdata.json loandata.json
